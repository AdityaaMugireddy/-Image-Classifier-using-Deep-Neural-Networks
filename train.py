...
def get_args():
    parser = argparse.ArgumentParser(description="Train a Deep Learning Model using Resnet for Image(Flower) Classification")
    ...
    parser.add_argument('--arch', default='resnet50',
                        help='Deep Neural Network architecture, options: resnet18, resnet34, resnet50')
    parser.add_argument('--learning_rate', default=0.001, type=float, help='learning rate')
    parser.add_argument('--hidden_units', default=1024, type=int, help='number of neurons in hidden layer')
    ...
    parser.add_argument('--gpu', default=True, action='store_true', help='GPU to be used for training?')
    ...
    for e in range(epochs):
        ...
        for images, labels in train_loader:
            ...
            if steps % print_every == 0:
                ...
                print(f"Training Loss: {t_loss:.4f} Validation Loss: {v_loss:.4f} Validation Accuracy: {v_acc:.4f}")
                running_loss = 0
                model.train()
